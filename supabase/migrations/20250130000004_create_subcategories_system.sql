-- Create subcategories system for dynamic skill fetching
-- This migration creates tables for categories and subcategories
...
-- Only admins can modify categories and subcategories
...
-- 8. Insert Digital Marketing subcategories
INSERT INTO public.subcategories (category_id, name, description, skills)
SELECT 
  c.id,
  subcategory_name,
...
-- 9. Insert Blockchain subcategories
INSERT INTO public.subcategories (category_id, name, description, skills)
SELECT 
  c.id,
  subcategory_name,
