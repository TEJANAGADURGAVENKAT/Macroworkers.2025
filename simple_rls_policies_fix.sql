-- =====================================================
-- SIMPLE RLS POLICIES FIX FOR SLOT COUNTING
-- =====================================================
-- This script fixes ONLY the RLS policies issue for slot counting (simplified version)
...
-- Step 3: Create ONLY the essential policies for slot counting to work
...
-- Step 4: Test if the universal trigger is working with RLS policies
DO $$
DECLARE
  test_task_id UUID;
  test_worker_id UUID;
...
-- Step 6: Check if universal trigger exists
SELECT 
