-- =====================================================
-- CHECK AND FIX TRIGGER (RLS IS DISABLED)
-- =====================================================
-- Since RLS is disabled, the issue is with the trigger itself

-- Step 1: Check if any triggers exist on task_assignments
SELECT 
...
-- Step 3: Create a simple, working trigger
-- Drop ALL existing triggers first (including the one that already exists)
...
SELECT 
  ...
  'Simple trigger created and working!' as message,
