...
const RaiseDispute = () => {
  ...
  const disputeTypes = [
    { value: 'payment', label: 'Payment Issue', description: 'Problems with payment processing or delays' },
    { value: 'rejection', label: 'Task Rejection', description: 'Unfair task rejection or unclear feedback' },
    { value: 'quality', label: 'Quality Issue', description: 'Disagreement about work quality assessment' },
    { value: 'other', label: 'Other', description: 'Any other issue not covered above' }
  ];

  // Load employers for the dropdown
  useEffect(() => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const disputeData = {
        ...
        raised_by: user.id,
        against: form.employerId, // Add the employer ID as the against field
        status: 'open',
        priority: 'medium'
      };
    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-gray-600">Submit a complaint regarding a task, payment, or quality issue.</p>
        </motion.div>
          ...
          <Card>
            ...
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                {/* Employer Selection */}
                <div className="space-y-2">
                  <Label htmlFor="employerId">Select Employer</Label>
                  <div className="relative">
                    ...
                    >
                      <SelectTrigger className="pl-10">
                        <SelectValue placeholder={loadingEmployers ? "Loading employers..." : "Select an employer"} />
                      </SelectTrigger>
                      <SelectContent>
                        {employers.map((employer) => (
                          <SelectItem key={employer.user_id} value={employer.user_id}>
                  ...
                  {errors.employerId && (
                    <p className="text-xs text-red-500">{errors.employerId}</p>
                  )}
                  <p className="text-xs text-gray-500">
                    Select the employer involved in the dispute
                  </p>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Textarea
                    id="description"
                    placeholder="Explain your issue clearly. Include task details if possible."
