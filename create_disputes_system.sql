-- Complete Disputes System Setup
...
-- 2. Create dispute_attachments table
...
-- 3. Create dispute_comments table for admin-user communication
...
-- 5. Enable RLS on all dispute tables
...
-- 6. Create RLS policies for disputes table
...
-- 7. Create RLS policies for dispute_attachments table
-- Users can view attachments for disputes they have access to
...
-- Users can upload attachments for disputes they raised
...
-- 8. Create RLS policies for dispute_comments table
-- Users can view comments for disputes they have access to
...
-- Users can add comments to disputes they have access to
...
-- 9. Create function to generate dispute IDs
...
-- 10. Create trigger to auto-generate dispute IDs
...
-- 13. Create storage bucket for dispute attachments
INSERT INTO storage.buckets (id, name, public)
VALUES ('dispute-attachments', 'dispute-attachments', false)
ON CONFLICT (id) DO NOTHING;

-- 14. Create storage policies for dispute attachments
CREATE POLICY "Users can upload dispute attachments" 
ON storage.objects 
FOR INSERT 
WITH CHECK (
